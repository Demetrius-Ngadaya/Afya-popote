        ...
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('patients.update', $patient->id) }}" method="POST" class="w-100">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    <option value="Nilizo_enda" {{ $patient->appointments->first() && $patient->appointments->first()->status == 'Zilizo_hudumiwa' ? 'selected' : '' }}>Attended appointment</option>
                                    <option value="Nisizo_enda" {{ $patient->appointments->first() && $patient->appointments->first()->status == 'Zisizo_hudhuriwa' ? 'selected' : '' }}>Not attended appointment</option>
                                </select>
                            </div>
                        </div>
