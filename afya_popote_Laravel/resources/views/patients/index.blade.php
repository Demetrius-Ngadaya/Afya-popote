    ...
    <div class="content py-3">
        <div class="container-fluid">
            ...
            <table id="example" class="table table-striped table-responsive table-bordered nowrap" style="width:100%">
                ...
                @foreach ($newAppointmentsCount as $appointment)
    <tr>
        <td>{{ ++$i }}</td>
