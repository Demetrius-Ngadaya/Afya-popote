...
import 'package:afya_popote/components/custom_appbar.dart';
import 'package:afya_popote/main.dart';
import 'package:afya_popote/models/booking_datetime_converted.dart';
...
class _BookingPageState extends State<BookingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(
        appTitle: 'Chagua tarehe ya Ahadi',
        ...
        slivers: <Widget>[
          ...
          _isWeekend
            ...
            child: Container(
              ...
              child: const Text(
                'Samahani chagua tena,tarehe uliyochagua sio siku ya kazi ',
                style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                  color: Colors.grey,
            ...
            delegate: SliverChildBuilderDelegate(
                ...
                return InkWell(
                  ...
                  child: Container(
                    ...
                    alignment: Alignment.center,
                    child: Text(
                      '${index + 8}:00 ${index + 8 > 12 ? "Mchana" : "Asubuhi"}',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        color:
